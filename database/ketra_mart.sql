...
CREATE DATABASE IF NOT EXISTS `ketra-ecommerce` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ketra-ecommerce`;
...
INSERT INTO `banners` (`id`, `content`, `url`, `banner_type`, `image`, `status`, `created_at`, `updated_at`) VALUES
	(1, NULL, NULL, 'home', 'frontend/assets/images/banners/01.jfif', 'active', '2023-01-24 11:51:08', '2023-01-24 11:51:08'),
	(2, NULL, NULL, 'home', 'frontend/assets/images/banners/02.jfif', 'active', '2023-01-24 11:51:08', '2023-01-24 11:51:08'),
...
INSERT INTO `orders` (`id`, `user_id`, `order_number`, `total_amount`, `subtotal`, `payment_method`, `payment_status`, `order_status`, `payment_details`, `delivery_charge`, `quantity`, `coupon`, `first_name`, `last_name`, `email`, `phone`, `country`, `postcode`, `state`, `address`, `address2`, `scountry`, `spostcode`, `sstate`, `saddress`, `saddress2`, `note`, `deleted_at`, `created_at`, `updated_at`) VALUES
	(1, 1, 'KETRA-1000', 3000.00, 3000.00, 'cod', 'unpaid', 'pending', NULL, 100.00, 2, 100.00, 'Prajwal', 'Rai', 'prajwal.iar@gmail.com', '+971553879113', 'Nepal', 31091, 'Koshi', 'Kadaghari', 'Kadaghari', 'Nepal', 31091, 'Koshi', 'Kadaghari', NULL, 'Can u delivery within this week.', NULL, '2023-01-27 21:39:39', '2023-01-27 21:39:39');
...
INSERT INTO `settings` (`id`, `site_title`, `meta_description`, `meta_keywords`, `logo`, `favicon`, `phone`, `office_time`, `email`, `address`, `currency`, `system_version`, `website_url`, `facebook_url`, `instagram_url`, `twitter_url`, `youtube_url`, `recaptcha`, `recaptcha_key`, `recaptcha_secret`, `visitors`, `copyright_text`, `about_us`, `return_policy`, `shipping_payment`, `privacy_policy`, `terms_conditions`, `cancellation_policy`, `paypal_sandbox`, `delivery_time`, `created_at`, `updated_at`) VALUES
	(1, 'KETRA MART Shopping Site', 'KETRA MART online Shopping ', 'Shopping, Fashion dress, ecommerce', 'backend/assets/images/logo.png', '', '+971553879113', ' 9 AM - 6 PM (PDT) . MON-FRI', 'info@ketramart.com', 'Kadaghari, Nepal', '$', '1.0', NULL, 'https://facebook.com/', 'https://instagram.com/', 'https://twitter.com/', 'https://youtube.com/', 0, NULL, NULL, 5, '© Copyrights 2023. All rights reserved.', '{"description1":"Testing","description2":"Hello","image1":"1674697447-Category01.png","image1_path":"storage\\/frontend\\/images\\/settings\\/1674697447-Category01.png","image2":"1674697447-Category02.png","image2_path":"storage\\/frontend\\/images\\/settings\\/1674697447-Category02.png"}', NULL, NULL, NULL, 'Terms and condition', 'Cancellation page.', 0, 20, NULL, '2023-01-27 21:12:15');
